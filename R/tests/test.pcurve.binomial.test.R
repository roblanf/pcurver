...
test_that("pcurve.binomial.test works", {
	...
	expect_that(pcurve.binomial.test(p1)$'Number of p values >0.025', equals(0.0))
	expect_that(pcurve.binomial.test(p1)$'Number of p values <0.025', equals(5.0))
	...
	expect_that(pcurve.binomial.test(p2)$'Number of p values >0.025', equals(5.0))
	expect_that(pcurve.binomial.test(p2)$'Number of p values <0.025', equals(0.0))
	...
	expect_that(pcurve.binomial.test(p3)$'Number of p values >0.025', equals(0.0))
	expect_that(pcurve.binomial.test(p3)$'Number of p values <0.025', equals(0.0))
